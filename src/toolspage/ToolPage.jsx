...
import { Grid, Typography, Box, Card, CardContent, CardMedia, AppBar, Toolbar, IconButton, TextField } from '@mui/material';
...
const StyledCardTitle = styled(Typography)(({ theme }) => ({
    ...
    marginTop: '0.5rem',
    background: 'linear-gradient(135deg, rgba(255,94,135,0.05) 0%, rgba(255,94,135,0) 100%)',
    padding: '0.5rem',
        ...
        <Layout>
            ...
            <AppBar position="sticky" color="inherit" elevation={0} sx={{ 
                ...
                <Toolbar sx={{ padding: '0.5rem 1rem' }}>
                    ...
                    >
                        <ArrowBackIosNewIcon fontSize="small" style={{ color: COLORS.primary }} />
                    </IconButton>
            ...
            <Box sx={{ 
                ...
                <Grid container spacing={3} justifyContent="center">
                    {tools.map(tool => (
                        ...
                        >
                            <StyledCard onClick={tool.onClick} sx={{ 
                                ...
                                <StyledCardMedia
                                    ...
                                    alt={tool.name}
                                    sx={{
                                        filter: `hue-rotate(${Math.random() * 40 - 20}deg) brightness(1.05)`,
